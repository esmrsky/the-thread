...
const PATTERN = {
  ...
  seasons: [
    ...
    },
    {
      ...
      rows: [
        ...
        { k: 'Provision', v: ver('Manna stops the day they eat the land’s produce (Josh 5:12). Not abandonment — promotion. Provision changes shape by season.', 'Manna stops the day after they eat the land’s produce (Josh 5:12). Not abandonment — promotion. Provision changes shape by season.') }
      ]
    }
  ],
  insights: [
    ...
    { t: 'Identity comes before the test, never after it.', x: ver('“You are my beloved Son” (Matt 3:17) — before a single miracle or sermon. Then the very first attack: “IF you are the Son of God…” (Matt 4:3). The wilderness doesn’t ask what you can do. It asks whether you believe what the Voice said.', '“You are my beloved Son” (Mark 1:11) — before a single miracle or sermon. Then the very first attack: “IF you are the Son of God…” (Matt 4:3). The wilderness doesn’t ask what you can do. It asks whether you believe what the Voice said.') },
    ...
    { t: 'The giants were never the problem; the mirror was.', x: ver('Ten spies: “We seemed like grasshoppers IN OUR OWN EYES, and so we were in theirs” (Num 13:33). Same giants, same God — Caleb just did different math (“they are bread for us,” Num 14:9). Your self-image sets your ceiling more than your circumstances do.', 'Ten spies: “We seemed like grasshoppers IN OUR OWN EYES, and so we were in theirs” (Num 13:33). Same giants, same God — Caleb and Joshua just did different math (“they are bread for us,” Num 14:9). Your self-image sets your ceiling more than your circumstances do.') },
  ...
  cases: [
    { name: 'Israel', sub: 'the master case study', p1: ver('400 years of slavery — bricks, quotas, and a pharaoh who decides your worth (Ex 1).', '400 years of slavery — bricks, quotas, and a pharaoh who decides your worth (Ex 1; the 400 years, Gen 15:13).'), p2: '40 years of manna, water from rocks, and a syllabus called Deuteronomy 8:2 — humbled, tested, fathered.', p3: 'Jordan parts, Jericho falls, and the fight is FROM promise, not for it (Josh 1:3).' },
    ...
    { name: 'Moses', sub: 'the 40-40-40 life', p1: ver('40 years as a prince of Egypt — power, education, and a murder that proved zeal isn’t readiness (Ex 2).', '40 years as a prince of Egypt — power, education, and a murder that proved zeal isn’t readiness (Ex 2; the 40 years, Acts 7:23).'), p2: ver('40 years keeping sheep in Midian — the résumé God was actually building (Ex 3:1).', '40 years keeping sheep in Midian — the résumé God was actually building (Ex 3:1; Acts 7:30).'), p3: '40 years leading the exodus, face-to-face with God, “as a man speaks to his friend” (Ex 33:11).' },
    ...
    { name: 'Ruth', sub: 'famine to family tree', p1: 'Moab: famine, three funerals, and a mother-in-law who renamed herself “Bitter” (Ruth 1).', p2: 'Gleaning leftover barley in a stranger’s field — faithful obscurity, one row at a time (Ruth 2).', p3: ver('Redeemed and married by Boaz — grandmother of kings, name in the genealogy of Jesus (Ruth 4; Matt 1:5).', 'Redeemed and married by Boaz — great-grandmother of kings, name in the genealogy of Jesus (Ruth 4; Matt 1:5).') },
    ...
    { name: 'Paul', sub: 'zeal, then formation, then fire', p1: 'Rising star of the Pharisees — impeccable credentials aimed in exactly the wrong direction (Phil 3:4-6).', p2: ver('Damascus, then Arabia, then roughly a decade of Tarsus silence before the story needs him (Gal 1:17-18; Acts 11:25).', 'Damascus, then Arabia, then years of Tarsus silence before the story needs him (Gal 1:17-18; Acts 11:25).'), p3: 'The apostle to the nations — letters from prisons that became half the New Testament.' },
